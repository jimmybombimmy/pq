      ...
      <section className="audioSection">
        <div className="audioGridSection">
          ...
          <p className="audioInfo">
            ...
            Praesentium obcaecati itaque deserunt sit asperiores quam iure earum
            iusto placeat possimus. Quae assumenda esse, eligendi quasi
            doloribus hic perspiciatis explicabo ipsa similique, qui architecto
            aliquam consequuntur nobis, a in quibusdam accusantium autem! Nam
            facere voluptatibus nostrum incidunt tempora ipsa impedit cumque.
          </p>
          <img
